...
// §17.3 citation contract footer. Auto-appended to every prompt so step
// authors don't have to repeat the rules in each prompt body. Spec text is
// reproduced verbatim — changes here are spec changes.
