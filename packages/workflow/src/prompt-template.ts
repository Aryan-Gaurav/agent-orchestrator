...
// docs/workflow-engine.md §17.3 — verbatim citation contract appended to every
// rendered prompt. Tells the agent when to cite, how to format citations, and
// how to use ./.ao/aow-ref to resolve / verify them.
